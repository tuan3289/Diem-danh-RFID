...
var SS = SpreadsheetApp.openById('1Ym-FEebN278x11pYIVIGxMfQpEifI7_E3qPAuNwCc8Q');// thay Id nay thành Id trang tinh của bạn
...
var date_now = Utilities.formatDate(new Date(), "Asia/Ho_Chi_Minh", "yyyy/MM/dd"); // Lấy ngày hiện tại
var time_now = Utilities.formatDate(new Date(), "Asia/Ho_Chi_Minh", "hh:mm:ss a"); // Lấy giờ hiện tại
